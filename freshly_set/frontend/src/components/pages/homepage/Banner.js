...
function Banner() {
  return (
    <section id="promotion" className="Banner mx-[6px]  lg:mx-[10px] mt-[60px]  lg:mt-[67px] ">
      <div className='BannerWrapper relative bg-gradient-to-t from-[#FF0C1A]   via-[#1A1A1A] via-[20%] to-[#1A1A1A] pl-[8px] lg:pl-[14px] rounded-[10px] lg:rounded-[29px] lg:h-[500px]'>
         {/*Banner Images */}
        ...
        <div className='Block relative pt-[10px] lg:pt-[28px] pb-[22px] lg:pb-[110px] mr-[140px] lg:mr-[500px]'>
          ...
          <div className='DescAndButton mt-[10px] lg:mt-[40px] bg-yellow-30'>
            <div className='Descriptions block mr-[110px] lg:mr-[436px]'>
              <p className="text-[6px] lg:text-[15px] text-white text-start font-josefin font-[600] my-0">Freshly Farms brings you the freshest, handpicked produce straight to your table! Don't miss this exclusive opportunity to kickstart your journey to healthier, farm-to-plate meals. Sign up now and enjoy the goodness of nature at unbeatable prices.</p>
            </div>
            
            <div className='DescriptionAndButton mt-[10px] lg:mt-[30px] grid grid-cols-2'>
              <div className='Descriptions block mr-[10px] lg:mr-0'>
                  <p className="text-[6px] lg:text-[15px] text-white text-start font-josefin font-[600] my-0">Hurry, this offer is only for the first 500 signups!</p>
              </div>
              <Link to="/SignUp" className='Button block h-fit w-fit  lg:mx-auto bg-[#008000] cursor-pointer rounded-[6px] lg:rounded-[15px]  active:scale-90 transition-all duration-500 ease-out'>
                  <p className="text-center  text-white text-[8px] lg:text-[20px] font-inter font-[700] py-[4px] lg:py-[8px] px-[10px] lg:px-[40px] my-0 ">Sign Up & Save Now</p>
              </Link>
            </div> 
