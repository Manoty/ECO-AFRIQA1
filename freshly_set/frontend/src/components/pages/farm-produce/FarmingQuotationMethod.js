...
function FarmingQuotationMethod() {
    return (
        <div className="FarmingQuotationMethod mt-[50px] mx-[250px] pt-[50px] pb-[100px] px-[60px] rounded-[24px] border-solid border-[1px] border-[#0000008F] shadow-md shadow-[#00000040] ">
