...
function FarmingSystemSearch() {
    ...
    return (
        <div className="FarmingSystemSearch mt-[60px] pb-[40px] mx-[40px]  ">
            <div className="FarmingSystemWrapper py-[40px] px-[40px] border-solid border-[1px] border-[#0000008F] shadow-md shadow-[#00000040] rounded-[24px]">
                <div className="InnerContents">
                    ...
                    <div className="CardsWrapper mt-[40px] mx-[100px]">
                        ...
                        <div className="FilterFields mt-[20px] -mx-[40px] grid grid-cols-4 gap-x-[10px] gap-y-[30px] pb-[20px]">
                            {FarmingSystemsearchEntries.slice(0, filterNumber).map((SearchEntry) =>
